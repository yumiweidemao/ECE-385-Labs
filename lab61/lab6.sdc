...
set_input_delay -clock max10_clk1_50 -rise 0.5 [get_ports KEY*]
set_input_delay -clock max10_clk1_50 -rise 0 [get_ports SW*]

set_input_delay -clock clk_dram_ext -rise 0 [get_ports {altera_reserved_tdi altera_reserved_tms}]
...
set_output_delay -clock max10_clk1_50 -rise 0 [get_ports LEDR*]
set_output_delay -clock clk_dram_ext -rise 0 [get_ports altera_reserved_tdo]
...
set_false_path -from * -through [get_pins {altera_internal_jtag|tck}] -to *
